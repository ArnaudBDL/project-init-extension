...
This skill defines the mandatory engineering rules for Express work in this project.

## Role in This Project

Express is the selected Node.js HTTP framework. Its implementation must remain consistent with `00-META/context/stack.yml`, the active specification, architectural decisions and the existing codebase.
...
- Validate request parameters, bodies and query values.
- Propagate cancellation and timeouts to downstream work where supported.
...
- Do not throw asynchronous errors outside the project error strategy.
- Do not trust req.body without validation.
- Do not keep application state in module-global request variables.
