...
This skill defines the mandatory engineering rules for Micronaut work in this project.

## Role in This Project

Micronaut is the selected JVM application framework. Its implementation must remain consistent with `00-META/context/stack.yml`, the active specification, architectural decisions and the existing codebase.

## Mandatory Rules

- Use compile-time dependency injection.
- Use configuration properties with validation.
- Keep controllers thin.
- Preserve non-blocking execution on event-loop paths.
- Declare HTTP clients through typed interfaces when appropriate.
...
- Do not rely on runtime reflection where Micronaut compile-time facilities exist.
...
Before changing Micronaut code:
