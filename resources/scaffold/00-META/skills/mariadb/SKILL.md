...
This skill defines the mandatory engineering rules for MariaDB work in this project.

## Role in This Project

MariaDB is the selected relational database. Its implementation must remain consistent with `00-META/context/stack.yml`, the active specification, architectural decisions and the existing codebase.

## Mandatory Rules

- Use versioned migrations.
- Verify MariaDB-specific SQL compatibility.
- Use parameterized queries.
- Define constraints and indexes deliberately.
...
- Do not assume every MySQL feature behaves identically.
